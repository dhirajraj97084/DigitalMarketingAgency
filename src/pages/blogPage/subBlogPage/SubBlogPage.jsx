...
const blogCard = [
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/04/affordable.png",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/03/Add-a-little-bit-of-body-text-22.png",
    tital: "Best SEO Company In Uttarakhand – Digiswarm",
    p1: "In the busy world of online marketing, where every business wants to be seen, Search",
    src: "/seo",
    date: "March 30, 2024 ",
  },
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/03/12-Remarkable-Facts-About-Digital-Marketing-1536x864.webp",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/03/exemplari-marketing.png",
    tital: "Best Influencer Marketing Agency In Uttarakhand – Digiswarm",
    p1: "Are you a business owner in Dehradun looking to harness the power of influencer marketing,",
    src: "/influencer",
    date: "March 16, 2024 ",
  },
  {
  ...
  return (
    <Layout>
      <div className="div  w-full ">
        <img
          className="w-full md:h-[35em] opacity-50 h-[20em]"
          src="https://Digiswarm.com/wp-content/uploads/2024/02/BEST-ECommerce-Marketing-Agency.png"
          alt=""
        />
      </div>
