    ...
    <Layout>
      <div className=" bg-gray-100/75">
        <div className="main  flex justify-center items-center h-[30em]">
          <div className="text">
            <h1 className="lg:text-5xl px-2 md:text-4xl text-3xl font-serif text-center text-purple-500 ">
              About Us
            </h1>
            <h2 className="lg:text-4xl px-2 md:text-4xl text-3xl font-serif text-center text-black/90 py-2">
              Welcome to Digiswarm <br /> Your Trusted Partner for Digital
              Excellence in Uttarakhand!
            </h2>
            <p className=" px-2 text-xl font-serif text-center text-black/80 pt-3">
              At Digiswarm, we are more than just a digital marketing agency; we
              are your strategic ally in <br />
              navigating the dynamic and ever-evolving digital landscape. With a
        ...
        <div className="container mx-auto">
          <div className="boxes grid grid-cols-1 lg:grid-cols-3">
            <div className="item1 bg-white m-4 px-4 shadow-md py-6 ">
              <h1 className="w-20 bg-deep-purple-500  h-2 my-2"></h1>
              <h2 className="text-2xl font-bold pb-3 ">Who Are We</h2>
              <h3 className="text-balance">
                {" "}
                <span className="text-deep-purple-500  text-xl">
                  Digiswarm
                </span>{" "}
                is a digital marketing agency that offers a broad range of
                services. We offere a wide range of services to clients in a
                variety of industries. We also provide professional web design
                and development services for both B2B and eCommerce businesses.
              </h3>
            </div>
            <div className="item2 bg-white m-4 px-4 shadow-md py-6 ">
              ...
              <h3 className="text-balance">
                {" "}
                Many marketing organizations make it a point to maintain a
                customer-centric emphasis, but only a handful truly do so.
                Digiswarm stands out as an overall digital marketing firm.{" "}
              </h3>
            </div>
            <div className="item3 bg-white m-4 px-4 shadow-md py-6 ">
              ...
              <div className="icons flex gap-1 items-center pt-1">
                <h1>
                  <IoMdArrowDropright className="text-2xl text-purple-500 " />
                </h1>
                <Link className="/seo">
                  <h1 className="text-purple-500">SEO</h1>
                </Link>
              </div>
              ...
              <div className="icons flex gap-1 items-center pt-2">
                ...
                <Link className="/socialmedia">
                  <h1 className="text-purple-500 ">Social Media Marketing</h1>
                </Link>
              </div>
              <div className="icons flex gap-1 items-center pt-2">
                <h1>
                ...
                <Link className="/payperclick">
                  <h1 className="">Pay Per Click - PPC</h1>
                </Link>
              </div>
              <div className="icons flex gap-1 items-center pt-2">
                <h1>
                ...
                <Link className="/contentwriting">
                  <h1 className="">Content Writing</h1>
                </Link>
              </div>
              <div className="icons flex gap-1 items-center pt-2">
                <h1>
              ...
              <div className="icons flex gap-1 items-center pt-2">
                ...
                <Link className="/videoproduction">
                  <h1 className="">Video Production</h1>
                </Link>
              </div>
              <div className="icons flex gap-1 items-center pt-2">
                <h1>
                ...
                <Link className="/influencermarketing">
      ...
      <div className="boxes py-11 px-2 grid grid-cols-1 lg:grid-cols-2 container mx-auto  ">
        <div className="left ">
          <img
            className="lg:h-[35em] w-full lg:w-[35em]"
            src="https://Digiswarm.com/wp-content/uploads/2022/02/image-section-41-min.jpg"
            alt=""
          />
        </div>
        <div className="right">
          ...
          <h2 className="py-3 text-purple-500 text-xl font-semibold">
            Why We Are The Best Digital Marketing Company In Uttarakhand
          </h2>
          <p className=" pb-3 text-balance">
            Digiswarm is a leading digital marketing agency that helps
            businesses achieve their full potential online. Our journey began
            with a simple yet powerful vision – to empower businesses in
            Uttarakhand with the digital tools and strategies they need to
            succeed in the digital age. Since then, we’ve come a long way,
            helping numerous businesses thrive digitally through our expertise
            and dedication.
          </p>
          <p className=" pb-3 text-balance">
            Our team of experienced professionals is well-versed in the latest
            digital marketing trends and techniques, including SEO, PPC, social
            media marketing, and content marketing.
          </p>
          <p className=" pb-3 text-balance">
            At Digiswarm, our clients are at the heart of everything we do. We
            take the time to understand your business, goals, and challenges and
            work collaboratively to devise strategies that deliver real,
            measurable results. Our results-driven approach has helped many
            businesses increase their online visibility and drive more traffic
            to their websites.
          </p>
          <p className=" pb-3 text-balance">
            We are proud to have a proven track record of success and are
            committed to delivering results for our clients. We are passionate
            about helping businesses succeed online and take great pride in the
            success of our clients.
          </p>
          <p>
            Join us on this digital journey and experience the difference of
            working with the best digital marketing agency in Uttarakhand. Let’s
            grow your brand, drive conversions, and achieve digital excellence
            together.{" "}
          </p>
        </div>
      </div>
