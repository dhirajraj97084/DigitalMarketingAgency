...
const itemslist = [
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/03/Telecaller.png",
    tital: "Telemarketer",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/02/handsome-businessman-working-office.webp",
    tital: "Video Editor",
    desc: "Desired Skills & Experience:",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/02/social-media-marketing-concept-marketing-with-applications.webp",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2020/01/why-choose-us-1.jpg",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/01/search-engine-marketing-composition-design-1.webp",
    tital: "Creative Head",
    desc: "Desired Skills & Experience:",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/02/6-4.webp",
    tital: "PPC Expert",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/03/10660.jpg",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/04/shutterstock_715216228.jpg",
    tital: "Receptionist",
    desc: "Desired Skills & Responsibilities:",
  ...
  {
    img: "https://Digiswarm.com/wp-content/uploads/2024/04/man_with_papers_1_8de85b94d7.jpg",
...
function CareerPage() {
  ...
  return (
    <Layout>
      <div className="img">
        <img
          className="w-full md:h-[30em] opacity-50 h-[20em]"
          src="https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=600"
          alt=""
        />
      </div>
      <div className="container mx-auto">
        <h1 className="text-2xl md:text-3xl lg:text-4xl text-purple-500  font-bold py-3">
          Join our Team
        </h1>
        <h2 className="text-balance pb-7">
          We are a dynamic and rapidly growing digital marketing agency,
          committed to delivering cutting-edge solutions for our clients. If you
          are passionate about digital marketing and eager to make a significant
          impact in the industry, Digiswarm is the place for you.{" "}
        </h2>
      </div>
            ...
            <div className="subitems grid grid-cols-1 md:grid-cols-2">
              {itemslist.map((item, index) => (
                <div key={index} className="inner_box m-2 p-2 md:m-4 bg-white">
                  ...
                  <h2 className="text-xl font-bold text-black/60">
                    {item.desc}
                  </h2>
                  ...
                  <h1 className="text-center  underline decoration-deep-orange-700 underline-offset-8">
                    Apply Now
                  </h1>
                    ...
                    <div className="max-w-md mx-auto mt-8 p-6 ">
                      <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-center">
                          <button
                            type="submit"
                            className=" w-full bg-purple-500   text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                          >
                            SEND
                          </button>
                        </div>
          ...
          <div>
            <div className="box hidden md:block">
              <div className="heading flex gap-3 justify-center py-5">
                <img
                  className="w-12"
                  src="https://Digiswarm.com/wp-content/uploads/2019/12/Google-Reviews-transparent-2.png"
                  alt=""
                />
                <h1>
                  Google rated us Excellent with the Google Rating of 4.9 out of
                  5 based on more than 200+ Customer Reviews.
                </h1>
              </div>
              <div className="img flex gap-12 justify-center">
                <img
                  className="w-36"
                  src="https://Digiswarm.com/wp-content/uploads/2019/12/Asset-3.png"
                  alt=""
                />
                <img
                  className="w-36"
                  src="https://Digiswarm.com/wp-content/uploads/2019/12/Asset-2.png"
                  alt=""
                />
                <img
                  className="w-36"
                  src="https://Digiswarm.com/wp-content/uploads/2019/12/Asset-4.png"
                  alt=""
                />
                <img
                  className="w-36"
                  src="https://Digiswarm.com/wp-content/uploads/2019/12/Asset-6.png"
                  alt=""
                />
              </div>
            </div>
            <div className="paybox hidden  h-24 bg-gray-400 mt-12 md:flex justify-around items-center">
              <Link to={"https://pages.razorpay.com/pl_Nmyt3WAZ1b2ZW8/view"}>
              ...
              <div className="img flex">
                <Link to={"https://pages.razorpay.com/pl_Nmyt3WAZ1b2ZW8/view"}>
                  <img
                    src="https://Digiswarm.com/wp-content/uploads/2023/02/pay_methods_branding.png"
                    alt=""
                  />{" "}
                </Link>
              </div>
              <div className="button">
                <Link to={"https://pages.razorpay.com/pl_Nmyt3WAZ1b2ZW8/view"}>
                  {" "}
                  <button className="px-6 py-2 bg-indigo-500 text-white">
                    Pay Now
                  </button>
                </Link>
                <img
            ...
            <div className="box md:hidden py-6">
              <Link>
                <h1 className="flex justify-center text-xl font-bold text-purple-500  cursor-pointer">
                  {" "}
                  Click Here To Pay
                </h1>
              </Link>
