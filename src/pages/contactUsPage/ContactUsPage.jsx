...
function ContactUsPage() {
  return (
    <Layout>
      <div className="main flex justify-center items-center h-[35em] bg-no-repeat bg-cover bg-center bg-fixed bg-[url('https://Digiswarm.com/wp-content/uploads/2024/02/social-media-marketing-concept-marketing-with-applications.webp')]">
        <div className="text">
      ...
      <div className="container mx-auto py-10">
        <h1 className="font-bold text-deep-orange-400 text-center pb-4">
          WHERE ARE WE?
        </h1>
        <h2 className="font-bold text-2xl text-black text-center pb-4">
          Contact us for a conversation
        </h2>
        <h3 className="text-xl text-center">
          We are the best digital marketing agency in Uttrakhand.
        </h3>
        <div className="boxes">
          <div className="items grid grid-cols-1 lg:grid-cols-3 px-4 py-6">
            <div className="item1 bg-white shadow-md p-2 m-3 border-b-4 border-deep-orange-400 ">
              <Link
                to={
                  "https://www.google.com/maps/place/Digiswarm+-+Digital+Marketing+Agency/@29.2167567,79.4858036,15z/data=!4m6!3m5!1s0x39a09b4a1f139bff:0xdb29295c692a6d17!8m2!3d29.2168799!4d79.4859461!16s%2Fg%2F11p5m886bm?entry=ttu"
                }
              >
              ...
              <p className="text-balance text-center">
                Main Branch: Near Phooldei Banquet Hall Haripur Naik,
            ...
            <div className="item3 bg-white shadow-md p-2 m-3 border-b-4 border-deep-orange-400 ">
              ...
              <p className="text-balance text-center">contact@Digiswarm.com</p>
            </div>
          </div>
        </div>
      </div>
