      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between gap-3">
          <div className="w-full md:w-1/5 mb-4 md:mb-0 ">
            <h2 className="text-3xl font-bold mb-2 ">Digiswarm</h2>
            <p>
              With Digiswarm, you can attract, impress, and convert more leads
          ...
          <div className="w-full md:w-1/4">
            ...
            <p>
              Upper Badrishpur Colony, near 6 no Puliya, Dehradun, Uttarakhand
              248001, India
            </p>
            <p>
              <strong>Mail Us: hr@digiswarm.in</strong>
            </p>
          </div>
        </div>
        <div className="flex justify-between items-center mt-8 border-t border-gray-700 pt-4">
          ...
          <div>
            <p>
              &copy; {new Date().getFullYear()} Digiswarm. All rights reserved.
            </p>
          </div>
        </div>
      </div>
