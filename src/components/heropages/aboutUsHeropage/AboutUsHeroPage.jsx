...
function AboutUsHeroPage() {
    return (
        <div>
            <div className="box py-8 px-6 md:px-12 lg:px-28 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="left">
                    <div className="heading">
                        <h1 className='font-bold text-deep-orange-500 text-start pb-2'>WHY CHOOSE DIGIPHLOX</h1>
                        <h2 className='text-2xl font-bold md:text-4xl text-black  md:text-start'>We Are The Best Digital Marketing Agency <br /> In Haldwani (Uttarakhand)</h2>
